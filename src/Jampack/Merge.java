...
public class Merge {
    ...
    * </pre>
    *
    * @param B00 The first Zmat to be merged
    * @param B01 The second Zmat to be merged
    ...
    *
    * @param B00 The first Zmat to be merged
    * @param B10 The second Zmat to be merged
    * @return The composite Zmat A
    * @exception JampackException
    * Thrown if there is a nonconformity.
    */
    ...
    * @param B00 The first Zmat to be merged
    * @param B01 The second Zmat to be merged
    * @param B10 The third Zmat to be merged
    * @param B11 The fourth Zmat to be merged
    * @return The composite Zmat A
    * @exception JampackException
    * Thrown if there is a nonconformity.
    */
    ...
    * @param B00 The first Zmat to be merged
    * @param B01 The second Zmat to be merged
    * @param B02 The third Zmat to be merged
    * @return The composite Zmat A
    * @exception JampackException
    * Thrown if there is a nonconformity.
    */
    ...
    * @param B01 The second Zmat to be merged
    * @param B02 The third Zmat to be merged
    * @param B10 The fourth Zmat to be merged
    * @param B11 The fith Zmat to be merged
    * @param B12 The sixth Zmat to be merged
    * @return The composite Zmat A
    * @exception JampackException
    ...
    * @param B00 The first Zmat to be merged
    * @param B10 The second Zmat to be merged
    * @param B20 The third Zmat to be merged
    * @return The composite Zmat A
    * @exception JampackException
    * Thrown if there is a nonconformity.
    */
    ...
    * @param B10 The third Zmat to be merged
    * @param B11 The fourth Zmat to be merged
    * @param B20 The fith Zmat to be merged
    * @param B21 The sixth Zmat to be merged
    * @return The composite Zmat A
    * @exception JampackException
    * Thrown if there is a nonconformity.
    */
    ...
    * @param B11 The fith Zmat to be merged
    * @param B12 The sixth Zmat to be merged
    * @param B20 The seventh Zmat to be merged
    * @param B21 The heigth Zmat to be merged
    * @param B22 The nith Zmat to be merged
    * @return The composite Zmat A
    * @exception JampackException
    * Thrown if there is a nonconformity.
    */
